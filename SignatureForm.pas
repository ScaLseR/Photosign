...
begin
  ...
  begin
    ...
    Buttons[0].Text := 'Ок';
    Buttons[1].Text := 'Стереть';
    Buttons[2].Text := 'Отмена';
...
begin
  ...
  photoxsign.Image3.Width:=self.Image1.Width-100;
  photoxsign.Image3.Height:=self.Image1.Height;
  photoXsign.Image3.Picture:=self.Image1.Picture;
